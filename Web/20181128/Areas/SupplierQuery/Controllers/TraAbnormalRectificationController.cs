...
//-------------------------------------------------------------------------
//作成日　　    版本　　　作成者　　　meto
//2018-10-22    1.0        FJK        新建 - 通知查看_异常整改     
//-------------------------------------------------------------------------
#region 参考 
...
{
    public class TraAbnormalRectificationController : Controller
    {
        //
        // GET: /SupplierQuery/TraAbnormalRectification/
        ...
        public ActionResult AbnormityRecordList(int index, int size,string abnormityState)
        {
            // 查询本账户对应的运输供应商的异常整改信息 
            ...
            // 异常整改记录List
            List<TraAbnormityRecordModel> list = bll.AbnormityRecordListForSupplier(index, size, where);
        ...
        /// <param name="supplierType">供应商类型</param>
        /// <returns></returns>
        public int AbnormityRecordCount(string abnormityState)
        {
            // 查询本账户对应的运输供应商的异常整改信息 
            string where = " AbnormityState NOT IN (10,15) AND UserId =" + Auxiliary.UserID();
            ...
            return bll.AbnormityRecordCountForSupplier(where);
        }
